...
//TAREA
//
//Crear una funcion que tome como parámetro el año actual y el año de nacimiento
...
//Edad usuario
/*
let salarioAnual = Number(prompt('Cuánto es tu salario anual?'))
function calcularSalarioMensual(salarioAnual){
    const mesesDelAño = 12;
    return salarioAnual / mesesDelAño
}
console.log('Tu salario mensual es de ' + calcularSalarioMensual(salarioAnual));
*/
/*
let salarioMensual = Number(prompt('Cuánto cobras mensualmente?'))
...
/*
let añoActual = 2020
let añoDeNacimientoUsuario = prompt('En que año naciste?')
function calcularEdadUsuario(añoActual, añoDeNacimientoUsuario){
    return añoActual - añoDeNacimientoUsuario
}
console.log('Tu edad es ' + calcularEdadUsuario(añoActual, añoDeNacimientoUsuario))
*/
...
if (operador === "+") {
    ...
    resulado = dividir(numero1, numero2);
} else if (operador === "*") {
