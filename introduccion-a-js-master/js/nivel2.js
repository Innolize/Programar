...
//       cosas que te gustan.
//                              0         1            2             3
const comidasFavoritas = ['milanesas', 'asado', 'pollo al horno', 'flan'];
...
/*
comidasFavoritas[0] = "milanesas de pescado"
...
/*
function multiploDeTres(valor1){
        return valor1 % 3
}


function MultiploDeCinco(valor1){
        return valor1 % 5
}
...
for(i = 1; i < 51; i++){
    if(multiploDeTres(i) === 0 && MultiploDeCinco(i) === 0){
...
const numerosArray = [7, 5, 9, 2, 8]
let promedio = 0
for(let i=0; i < numerosArray.length; i++){
    promedio = promedio + numerosArray[i] / numerosArray.length
     
}console.log(`El promedio calculado es de ${promedio}`)
